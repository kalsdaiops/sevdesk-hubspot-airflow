...
# Function to create or update HubSpot contact
def create_or_update_contact():
    # Contact data (these can be dynamically passed if needed)
    first_name = "John"
    last_name = "Snow"
...
# Define the DAG
dag = DAG(
    "create_or_update_hubspot_contact",  # Name of the DAG
...
# Define the task to create or update the contact
create_or_update_contact_task = PythonOperator(
